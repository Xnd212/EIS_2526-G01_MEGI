...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2025 at 07:32 PM
...
(17, 1, 'Games', 12, 'Board Games', '2024-04-12', 'Collection of unique and vintage board games from around the world'),
(18, 1, 'Fashion', 12, 'Sneakers', '2024-06-18', 'Archive of rare and limited-edition sneakers spanning decades'),
(19, 1, 'Beverages', 12, 'Soda Cans', '2024-05-03', 'Assortment of collectible soda cans featuring iconic designs and flavors'),
(20, 1, 'Digital', 12, 'Internet Memes', '2024-07-21', 'Curated collection of memorable memes from internet history'),
(21, 1, 'Puzzles', 12, 'Rubik\'s Cubes', '2024-03-30', 'Variety of Rubik?s Cubes');
...
(15, 6, 42, 'Thriller', 12.99, 10, '2023-11-12', 'Record Store', 'Michael Jackson’s iconic best-selling album', '2025-12-08'),
(16, 6, 42, 'Back in Black', 11.5, 9, '2024-01-05', 'Online Store', 'AC/DC’s legendary hard rock release', '2025-12-08'),
(17, 6, 42, 'Rumours', 13.2, 8, '2024-02-18', 'Local Shop', 'Fleetwood Mac’s classic album with timeless hits', '2025-12-08'),
(18, 6, 42, 'Abbey Road', 14.75, 10, '2024-03-08', 'Music Market', 'The Beatles’ masterpiece featuring Come Together', '2025-12-08'),
(19, 6, 42, 'Nevermind', 12.4, 9, '2024-04-02', 'Convention', 'Nirvana’s groundbreaking grunge-era defining record', '2025-12-08'),
(30, 6, 42, 'The Emperor\'s New Clothes', 13.99, 9, '2025-08-10', 'Online Store', 'Raekwon’s 2025 comeback — sharp storytelling and boom‑bap beats', '2025-12-08'),
(31, 6, 42, 'Lotus', 14.5, 9, '2025-07-01', 'Record Store', 'Little Simz’s 2025 release blending hip‑hop with jazz, funk and soul textures', '2025-12-08'),
(32, 6, 42, 'Deep Thoughts', 12.99, 8, '2025-06-15', 'Digital Download', 'Lil Durk’s latest, introspective 2025 album with melodic trap & rap vibes', '2025-12-08'),
(34, 6, 42, 'Let God Sort Em Out', 14.75, 9, '2025-09-01', 'Online Store', 'Clipse’s 2025 reunion album, heavily anticipated and already talked‑about in hip‑hop circles', '2025-12-08'),
(36, 6, 42, 'Projecto Mary Witch', 11.49, 9, '2024-06-02', 'Online Store', 'ProfJam’s genre-bending and poetic release', '2025-12-08'),
(37, 6, 42, 'Odisseia', 12, 7, '2024-04-22', 'Music Fair', 'Valete’s powerful and politically charged album', '2025-12-08'),
(38, 6, 42, 'True EP', 8.75, 6, '2024-03-18', 'Record Store', 'Sam The Kid’s smooth beats and lyrical mastery', '2025-12-08'),
(39, 6, 42, 'Sem Cerimónias', 10.2, 8, '2024-02-27', 'Convention', 'Holly Hood’s raw and energetic trap-influenced record', '2025-12-08');
