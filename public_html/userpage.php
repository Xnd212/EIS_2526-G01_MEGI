  ...
  <section class="user-info">
    <div class="user-profile-box">
      <div class="user-box">
        ...
        <img src="images/userimage.png" alt="User Photo" class="user-photo" />

        <div class="user-info-wrapper">
          
          <div class="user-details-and-stats">
            <div class="user-details">
              <h2 class="username">Susana_Andrade123</h2>
              <p class="email">susana_andrade123@gmail.com</p>
            ...
            <!-- Stats à direita -->
            <div class="stats">
              <div><strong>247</strong><br>Items</div>
              <div><strong>5</strong><br>Collections</div>
              <div><strong>65</strong><br>Friends</div>
            </div>
          </div>
    ...
    <section class="friends">
      ...
      <div class="friends-grid">
        ...
        <div class="friend">
          ...
          <p class="friend-name"><strong>Tomás_Freitas</strong></p>
          </a>
        </div>
        <div class="friend">
          <a href="friendpage.php">
