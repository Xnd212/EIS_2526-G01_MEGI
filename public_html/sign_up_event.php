...
<div class="main">
    <div class="content">
      <section class="event-signup-section">
        ...
        <form id="eventSignUpForm" novalidate>
          <!-- Nome do utilizador -->
          <div class="form-group">
            <label for="userName">User Name</label>
            <input type="text" id="userName" name="userName" readonly value="Susana_Andrade123" />
          </div>
        ...
        <div id="summarySection" class="summary-section hidden">
          ...
          <div class="summary-actions">
            <button id="editRegistration" class="btn-secondary">Edit Registration</button>
            <button id="finalConfirm" class="btn-primary">Confirm Final Registration</button>
          </div>
        </div>
      </section>
    </div>
