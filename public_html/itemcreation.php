    ...
    <div class="content">
      <section class="item-creation-section">
        ...
        <form id="itemForm" novalidate>
          ...
          <!-- Custom Multi-Select for Collection -->
          <div class="form-group">
            ...
            <div class="custom-multiselect">
              ...
              <div class="dropdown-content" id="dropdownContent">
                <label><input type="checkbox" value="pokemon"> Pokémon Cards</label>
          ...
          <div class="form-group">
            ...
            <input type="number" id="itemPrice" name="itemPrice" placeholder="Enter price" step="0.01" min="0" />
          </div>

          <!-- Item Type -->
          <div class="form-group">
            <label for="itemType">Item Type <span class="required">*</span></label>
            <input type="text" id="itemType" name="itemType" placeholder="Enter item type (e.g., Card, Figure, Poster)" />
          </div>
          ...
          <div class="form-group">
              ...
              <div class="slider-wrapper">
                  <input type="range" id="itemImportanceSlider" name="itemImportanceSlider" min="1" max="10" step="1" value="5" />
          ...
          <div class="form-group">
            ...
            <input type="text" id="acquisitionPlace" name="acquisitionPlace" placeholder="Enter where item was acquired" />
          </div>
